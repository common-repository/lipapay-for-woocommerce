...
//		array_push($this->supports,'refunds');
	    ...
	    $this->method_description='contact us : info@lipapay.com';
	   
		$this->init_form_fields ();
		$this->init_settings ();
		
		$this->title = 'LipaPay';
		$this->description = 'Support Visa & Master Cards, and local Mobile Money';
    ...
    public function check_LipaPay_response(){
        ...
        if($_POST && isset($_POST['merchantOrderNo'])){
            ...
            unset($data['sign']);
            $my_sign = Lipapay_return_sign($data,$LipaPay_key);
            ...
            if($result){
                if($data['status']=='SUCCESS'){
                    ...
                    $my_sign = Lipapay_return_sign($return,$LipaPay_key);
                    $return['sign'] =$my_sign;
	...
	function receipt_page($order_id) {
        ...
        if($env=='testing'){
            ...
            $param['url'] =$url =  'https://www.lipapay.com/api/excashier.html';
        }
